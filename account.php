...
<title>Project Worlds || Exam System </title>
...
<div class="row">
<div class="col-lg-6">
<img src="image/AITRC LOGO.png" width=130 height=70 alt="shubham mahadik" class="">
  ...
  <script>
        function startTimer(duration, display) {
            ...
            setInterval(function () {
                ...
                if (--timer < 0) {
                    // You can customize what happens when the timer reaches 0
                    alert("Time's up!");
                    // Optionally, redirect to another page or take any other action
                    // window.location.href = "exam_finished.php";
                }
            }, 1000);
        }

        document.addEventListener("DOMContentLoaded", function () {
            var timerDuration = <?php echo isset($_GET['time']) ? intval($_GET['time']) : 60; ?>; // Set default duration to 60 seconds
...
echo'<input type="submit" name="ctl00$ContentPlaceHolder1$btnPrev" onclick="previous()"value="Previous" id="ctl00_ContentPlaceHolder1_btnPrev" disabled="disabled" class="btn-primary" /> &nbsp&nbsp&nbsp';

echo'<input type="submit" name="ctl00$ContentPlaceHolder1$btnNext" value="Next" id="ctl00_ContentPlaceHolder1_btnNext" class="btn-primary" style="width:75px;" />&nbsp&nbsp
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/AITRC LOGO.png" width=100 height=100 alt="Shubham mahadik" class="img-rounded">
		 </div>
		 <div class="col-md-5">
				<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Develope By</h4>
		<h4 style="font-family:'typo' ">Mr.Shubham Mahadik</h4>
    <h4 style="font-family:'typo' ">Miss.Janhavi Gade</h4>
    <h4 style="font-family:'typo' ">Miss.Tanisha Kamble</h4>
    <h4 style="font-family:'typo' ">Miss.Snehal Pudhale</h4>
		<h4 style="font-family:'typo' ">Adarsh Institute of Technology and Research Center Vita </h4></div></div>
		</p>
      </div>
